...
class PopularTvShows : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.popular_shows)
    ...
    private fun getMovieData(callback: (List<Movie>) -> Unit) {
        ...
        apiService.getPopularTvShowsList().enqueue(object : Callback<MovieResponse> {
